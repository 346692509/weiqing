<?php defined('IN_IA') or exit('Access Denied');?><div class="panel we7-panel panel-reply">
		...
		<div class="we7-select-msg">
			<ul class="tab-navs">
				<li class="tab-nav tab-appmsg active <?php  if($options['news']) { ?>hidden<?php  } ?>">
					<a href="javascript:void(0);"<?php  if($_GPC['a'] == 'mass') { ?> onclick="select_mediaid('news', 'wx')"<?php  } else { ?> onclick="select_mediaid('news')"<?php  } ?>>
				...
				<li class="tab-nav tab-img <?php  if($options['image']) { ?>hidden<?php  } ?>">
					<a href="javascript:void(0);" onclick="select_mediaid('image');">
						...
						<span class="msg-tab-title"><?php  if(in_array($_W['account']['type'], array(ACCOUNT_TYPE_XZAPP_NORMAL, ACCOUNT_TYPE_XZAPP_AUTH))) { ?>熊掌号<?php  } else { ?>微信<?php  } ?>图片</span>
					</a>
				</li>
				...
				<li class="tab-nav tab-cardmsg <?php  if($options['keyword']) { ?>hidden<?php  } ?>">
					<a href="javascript:void(0);" onclick="select_mediaid('keyword');">
						...
						<span class="msg-tab-title"><?php  if($_GPC['m'] == 'welcome') { ?>匹配<?php  } else { ?>触发<?php  } ?>关键字</span>
					</a>
				</li>
