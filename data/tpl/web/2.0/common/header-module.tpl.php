...
<div class="sub-module-info">
	<div class="module-info-name">
		<?php  if(empty($_W['current_module']['logo'])) { ?>
			<img src="./resource/images/init_module_logo.png" class="head-app-logo" onclick="initModuleLogo()">
		<?php  } else { ?>
			<img src="<?php  echo tomedia($_W['current_module']['logo'])?>" class="head-app-logo">
		<?php  } ?>
