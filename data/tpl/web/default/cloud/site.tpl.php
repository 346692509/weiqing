	...
	<div class="form-files-box sms-index">
		<div class="form-files">
			...
			<div class="form-file">
				...
				<div class="form-edit">
					<a class="color-default" data-toggle="modal" data-target="#full_token">查看全部</a>
				</div>
			</div>
			<div class="form-file">
				...
				<div class="form-value">
					...
					<?php  } else { ?>
					免费版
					<a href="//s.we7.cc/goods-1.html" class="color-default" target="_blank">升级为商业服务</a>&nbsp;&nbsp;
					<a href="//s.we7.cc/goods-1.html" class="color-default" target="_blank">商业版介绍</a>
					<?php  } ?>
				</div>
				<div class="form-edit"></div>
			</div>
			<div class="form-file">
				...
				<div class="form-edit">
					<a href="//s.we7.cc/goods-6.html" target="_blank">购买增值服务</a>
				</div>
			</div>
			<div class="form-file">
		...
		<div class="form-files we7-margin-top">
			...
			<div class="form-file">
				<div class="form-label">关联论坛ID</div>
