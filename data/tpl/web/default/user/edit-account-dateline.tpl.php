...
<span id="js-user-edit-account" ng-controller="UserEditAccount" ng-cloak>
	...
	<table class="table we7-table ">
		...
		<tr>
			<th class="user-dateline-box">
				<span class="color-default">总计</span>用户有效期<i  data-trigger="hover" data-toggle="popover" data-placement="bottom"  data-html="true" data-content="</i>
					用户有效期由<span class='color-red'>用户所在的用户组</span>、主管理员设置的<span class='color-red'>附加时间</span>、用户自己在<span class='color-red'>商城购买的用户组</span>构成。请单独修改对应选项" class='wi wi-info color-default'></i>
			</th>
			<th class="text-left">
		...
		<tr>
			...
			<td class="text-left">{{ extra_limit_info.timelimit > 0 ? (extra_limit_info.timelimit * 1 + ' 天') : '永久' }}</td>
			<td class="text-right">
