	...
	<div class="panel we7-panel">
		...
		<div class="panel-body">
			<div class="account-num-statistics">
				<div class="item">
					<div class="num">
						<?php  if(!$user_founder_info) { ?>
						    {{account_num.max_total - account_num.founder_limit_total > 0 ? account_num.founder_limit_total + account_num.created_total : account_num.max_total + account_num.created_total}}
						<?php  } else { ?>
						    {{account_num.max_total - account_num.founder_limit_total > 0 ? account_num.founder_limit_total + account_num.current_vice_founder_user_created_total : account_num.max_total + account_num.current_vice_founder_user_created_total}}
						<?php  } ?>
					</div>
				...
				<div class="item">
					<div class="num">{{account_num.limit_total - account_num.founder_limit_total > 0 ? account_num.founder_limit_total : account_num.limit_total}}</div>
				...
				<div class="tab-pane active"  id="notice">
					<ul class="list-group notice-statistics">
						...
						<li class="list-group-item" >
							<a href="<?php  echo $notice['url'];?>" style="<?php  if(!empty($notice['style'])) { ?><?php  if(!empty($notice['style']['color'])) { ?>color: <?php  echo $notice['style']['color']?>;<?php  } ?><?php  if(!empty($notice['style']['bold'])) { ?>font-weight:bold;<?php  } ?><?php  } ?>"><?php  echo $notice['title'];?></a>
							<span class="pull-right color-gray">
								<?php  echo $notice['createtime'];?>
							</span>
						</li>
						<?php  } } ?>
						<?php  } else { ?> 
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<div class="modal-body">
					<div class="type-list">
						<?php  if(!empty($account_num['account_limit']) && (!empty($account_num['founder_account_limit']) && $_W['user']['owner_uid'] || empty($_W['user']['owner_uid'])) || $_W['isfounder'] && !user_is_vice_founder()) { ?>
						...
						<?php  if(!empty($account_num['wxapp_limit']) && (!empty($account_num['founder_wxapp_limit']) && $_W['user']['owner_uid'] || empty($_W['user']['owner_uid'])) || $_W['isfounder'] && !user_is_vice_founder()) { ?>
						...
						<?php  if(!empty($account_num['webapp_limit']) && (!empty($account_num['founder_webapp_limit']) && $_W['user']['owner_uid'] || empty($_W['user']['owner_uid'])) || $_W['isfounder'] && !user_is_vice_founder()) { ?>
						...
						<?php  if(!empty($account_num['phoneapp_limit']) && (!empty($account_num['founder_phoneapp_limit']) && $_W['user']['owner_uid'] || empty($_W['user']['owner_uid'])) || $_W['isfounder'] && !user_is_vice_founder()) { ?>
						...
						<?php  if(!empty($account_num['xzapp_limit']) && (!empty($account_num['founder_xzapp_limit']) && $_W['user']['owner_uid'] || empty($_W['user']['owner_uid'])) || $_W['isfounder'] && !user_is_vice_founder()) { ?>
						...
						<?php  if(!empty($account_num['aliapp_limit']) && (!empty($account_num['founder_aliapp_limit']) && $_W['user']['owner_uid'] || empty($_W['user']['owner_uid'])) || $_W['isfounder'] && !user_is_vice_founder()) { ?>
						...
						<?php  if(!empty($account_num['baiduapp_limit']) && (!empty($account_num['founder_baiduapp_limit']) && $_W['user']['owner_uid'] || empty($_W['user']['owner_uid'])) || $_W['isfounder'] && !user_is_vice_founder()) { ?>
						...
						<?php  if(!empty($account_num['toutiaoapp_limit']) && (!empty($account_num['founder_toutiaoapp_limit']) && $_W['user']['owner_uid'] || empty($_W['user']['owner_uid'])) || $_W['isfounder'] && !user_is_vice_founder()) { ?>
...
<script>
	angular.module('homeApp').value('config', {
		...
		is_empty_accounts : "<?php  echo $is_empty_accounts;?>",
		is_empty_modules : "<?php  echo $is_empty_modules;?>",
		'account_types' : {
