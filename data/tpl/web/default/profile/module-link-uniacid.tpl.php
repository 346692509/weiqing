...
<div class="alert we7-page-alert">
	...
	<p><i class="wi wi-info-sign"></i>可以非<?php  echo $_W['account']['type_name'];?>的其他应用的会员、数据等信息同步至<?php  echo $_W['account']['type_name'];?>应用当中；</p>
...
<div id="js-app-module-link-uniacid" ng-controller="appModuleLinkUniacidCtrl" ng-cloak>
	<table class="table we7-table table-hover vertical-middle">
		...
		<tr ng-repeat="module in modules" ng-if="modules">
			...
			<td class="text-left" ng-if="module.link_uniacid_info">
				<img ng-src="{{module.link_uniacid_info.logo}}" style="width:50px;height:50px;">
				<span>{{module.link_uniacid_info.name}}</span>
			</td>
			<td class="text-left" ng-if="!module.link_uniacid_info && !module.other_link">
				<span>暂无</span>
			</td>
			<td class="text-left" ng-if="!module.link_uniacid_info && module.other_link">
			...
			<td>
				<div class="link-group" ng-if="module.link_uniacid_info">
					<a href="javascript:;" ng-click="initModule(module.name)">修改</a>
					<a href="javascript:;" ng-click="module_unlink_uniacid(module.name)">删除</a>
				</div>
				<div class="link-group" ng-if="!module.link_uniacid_info && !module.other_link">
