...
<ul class="we7-page-tab">
	<li><a href="<?php  echo url('platform/reply', array('m' => 'keyword'));?>">关键字自动回复 </a></li>
	<li><a href="<?php  echo url('platform/reply', array('m' => 'special'));?>">非文字自动回复</a></li>
	<li><a href="<?php  echo url('platform/reply', array('m' => 'welcome'));?>">首次访问自动回复</a></li>
	<li><a href="<?php  echo url('platform/reply', array('m' => 'default'));?>">默认回复</a></li>
	<?php  if(!in_array($_W['account']['type'], array(ACCOUNT_TYPE_XZAPP_NORMAL, ACCOUNT_TYPE_XZAPP_AUTH))) { ?>
	<li><a href="<?php  echo url('platform/reply', array('m' => 'service'));?>">常用服务</a></li>
	<li><a href="<?php  echo url('platform/reply', array('m' => 'userapi'));?>">自定义接口回复</a></li>
	<?php  } ?>
