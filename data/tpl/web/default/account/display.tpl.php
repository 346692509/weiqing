						...
						<a class="info" href="{{detail.switchurl}}&type={{detail.type}}">
							...
							<div class="name " >
								...
								<div class="type" ng-if="detail.type_sign == 'account'">
									<span>微信公众号</span>
									<span ng-if="detail.need_upload == 1" class="new-version">新版本</span>
								</div>
								<div class="type" ng-if="detail.type_sign == 'account'">
				...
				<div class="modal-dialog" role="document">
					<div class="modal-content">
						...
						<div class="modal-body">
							<div class="type-list">
								<?php  if(!empty($account_info['account_limit']) && (!empty($account_info['founder_account_limit']) && $user_founder_uid || empty($user_founder_uid)) || $_W['isfounder'] && !user_is_vice_founder()) { ?>
								...
								<?php  if(!empty($account_info['wxapp_limit']) && (!empty($account_info['founder_wxapp_limit']) && $user_founder_uid || empty($user_founder_uid)) || $_W['isfounder'] && !user_is_vice_founder()) { ?>
								...
								<?php  if(!empty($account_info['webapp_limit']) && (!empty($account_info['founder_webapp_limit']) && $user_founder_uid || empty($user_founder_uid)) || $_W['isfounder'] && !user_is_vice_founder()) { ?>
								...
								<?php  if(!empty($account_info['phoneapp_limit']) && (!empty($account_info['founder_phoneapp_limit']) && $user_founder_uid || empty($user_founder_uid)) || $_W['isfounder'] && !user_is_vice_founder()) { ?>
								...
								<?php  if(!empty($account_info['xzapp_limit']) && (!empty($account_info['founder_xzapp_limit']) && $user_founder_uid || empty($user_founder_uid)) || $_W['isfounder'] && !user_is_vice_founder()) { ?>
								...
								<?php  if(!empty($account_info['aliapp_limit']) && (!empty($account_info['founder_aliapp_limit']) && $user_founder_uid || empty($user_founder_uid)) || $_W['isfounder'] && !user_is_vice_founder()) { ?>
								...
								<?php  if(!empty($account_info['baiduapp_limit']) && (!empty($account_info['founder_baiduapp_limit']) && $user_founder_uid || empty($user_founder_uid)) || $_W['isfounder'] && !user_is_vice_founder()) { ?>
								...
								<?php  if(!empty($account_info['toutiaoapp_limit']) && (!empty($account_info['founder_toutiaoapp_limit']) && $user_founder_uid || empty($user_founder_uid)) || $_W['isfounder'] && !user_is_vice_founder()) { ?>
