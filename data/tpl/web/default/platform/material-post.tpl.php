			...
			<div class="row we7-form col-sm-12 other-box">
				<div class="form-group">
					...
					<div>
						...
						<a  href="javascript:void(0);" class="btn btn-default we7-margin-left" ng-click="pickPicture('wechat')"><?php  echo $_W['account']['type_name'];?>图片</a>
	...
	<nav class="navbar navbar-wxapp-bottom navbar-fixed-bottom" role="navigation">
		<div class="container">
			<div class="pager">
				...
				<a id="savewechat" type="button" class="btn btn-primary" ng-click="saveNews('wechat')" ng-show="(!hidenbutton && materialList.length <= 8) || operate == 'add' && new_type == 'reply'">保存并上传到<?php  echo $_W['account']['type_name'];?></a>
			</div>
		</div>
	</nav>
</div>
