...
if ($do == 'system') {
	...
	$statistics_order['today'] = table('store_order')->getStatisticsInfoByDate($today_start, $today_start + 86400);
	$statistics_order['yestoday'] = table('store_order')->getStatisticsInfoByDate($yestoday_start, $yestoday_start + 86400);
