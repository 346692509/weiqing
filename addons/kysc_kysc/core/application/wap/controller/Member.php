    ...
    public function memberIndex()
    {
        ...
        if($is_support_bargain == 1){
            ...
            if($bargain_config['is_use'] == 1){
                $member_menu_arr["my_bargain"] = array(
                    '我的砍价',
                    'Member/myBargain'
                );
            }
            $this->assign('is_bargain',$bargain_config['is_use']);
        }else{
            $this->assign('is_bargain', 0);
        }
...
//             ),
    ...
    public function memberAddress()
    {
        ...
        $is_weixin_browser = strpos($_SERVER['HTTP_USER_AGENT'], 'MicroMessenger');
        $this->assign("is_weixin_browser", $is_weixin_browser);
    ...
    public function myBargain()
    {
    	...
    	if (request()->isAjax()) {
           ...
           return view($this->style . "/Member/myBargain");
        }
