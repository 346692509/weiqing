...
//                 'fictitious_sales' => $item['fictitious_sales'],
     ...
     */
    public function addBargainLaunch($bargain_id, $sku_id, $address_id, $distribution_type){
        ...
        try {
            ...
            if($distribution_type == "logistics"){
                ...
                $shipping_type = 1;
                $pick_up_id = 0;
            }elseif($distribution_type == "pickup"){
                $address_info = $member_service->getDefaultExpressAddress();
                $shipping_type = 2;
                $pick_up_id = $address_id;
            }
            //获取选择该商品规格的信息
            ...
            $goods_calculate->subGoodsStock($goods_sku_info['goods_id'], $sku_id, 1, '');
    ...
    public function setBargainPartakeRecord($launch_id){
        ...
        if($sum_bargain_money >= $bargain_money){
            ...
            $order_id = $order_service->orderCreateBragain($out_trade_no, $bargain_launch_info['sku_id'].":1",
                ...
                $bargain_launch_info['receiver_name'], $sum_bargain_money, $bargain_launch_info['uid'], $launch_id, $bargain_launch_info['shipping_type'], $bargain_launch_info['pick_up_id']);
