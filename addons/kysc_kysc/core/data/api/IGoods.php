...
interface IGoods
{
     ...
     * @param unknown $sort            
     */
    function addGoodsSpecService($shop_id, $spec_name, $show_type, $is_visible, $sort, $spec_value_str, $attr_id = 0, $is_screen, $spec_des,$goods_id);
     ...
     * @param unknown $sort            
     */
    function updateGoodsSpecService($spec_id, $shop_id, $spec_name, $show_type, $is_visible, $sort, $spec_value_str, $is_screen, $spec_des,$goods_id);
