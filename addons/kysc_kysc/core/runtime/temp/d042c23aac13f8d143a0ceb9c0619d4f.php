<?php if (!defined('THINK_PATH')) exit(); /*a:17:{s:41:"template/wap/default_new/Index/index.html";i:1566302470;s:34:"template/wap/default_new/base.html";i:1566302521;s:38:"template/wap/default_new/urlModel.html";i:1566305964;s:35:"template/wap/default_new/share.html";i:1566305971;s:48:"template/wap/default_new/Index/controlSlide.html";i:1566302472;s:49:"template/wap/default_new/Index/controlSearch.html";i:1566302473;s:46:"template/wap/default_new/Index/controlNav.html";i:1566302474;s:49:"template/wap/default_new/Index/controlNotice.html";i:1566302474;s:49:"template/wap/default_new/Index/controlCoupon.html";i:1566302476;s:56:"template/wap/default_new/Index/controlPromotionGame.html";i:1566302473;s:52:"template/wap/default_new/Index/controlFigureAdv.html";i:1566302475;s:51:"template/wap/default_new/Index/controlDiscount.html";i:1566302475;s:59:"template/wap/default_new/Index/AdminRecommendGoodsList.html";i:1566302478;s:46:"template/wap/default_new/controlCopyRight.html";i:1566302518;s:82:"template/wap/default_new/CustomTemplate/controlCommonCustomTemplateBaseFooter.html";i:1566302517;s:36:"template/wap/default_new/footer.html";i:1566302500;s:43:"template/wap/default_new/shareContents.html";i:1566305970;}*/ ?>
<!DOCTYPE html>
<html>
<head>
...
<div class="hot" style="position: relative; overflow: hidden;border-bottom: 1px solid #eee;">
	...
	<div style="width:70%;overflow:hidden;font-size:13px;color: #666;">
		...
		<ul style="position: relative;">
			 ...
			 <a href="<?php echo __URL('APP_MAIN/index/noticeContent', 'id='.$vo['id']); ?>"> <li> &nbsp;&nbsp;&nbsp;&nbsp;<?php echo $vo['notice_title']; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</li></a>
			 <?php endforeach; endif; else: echo "" ;endif; ?>
		</ul>	 
		</div>
	</div>
...
function updateEndTime() {
	...
	<?php endif; if($is_support_pintuan == 1): $service = new data\service\Pintuan;$list = $service->getTuangouGoodsList("1","5", "npg.is_open=1 and npg.is_show=1","npg.create_time desc","*");$list = json_encode($list);$list = json_decode($list, true); if($list['data']): ?>
	...
	<!-- 新品 精品 热卖等推荐商品-->
	<!-- 新品 -->
<?php if(count($recommend_goods_list['goods_new_list'])): ?>
	<div class="floor">
		<div class="category_name">
			<span class="floor-left-nav"><i class="title-border"></i>新品</span>
		...
		<section class="members_goodspic">
			<ul>
				<?php if(is_array($recommend_goods_list['goods_new_list']) || $recommend_goods_list['goods_new_list'] instanceof \think\Collection || $recommend_goods_list['goods_new_list'] instanceof \think\Paginator): if( count($recommend_goods_list['goods_new_list'])==0 ) : echo "" ;else: foreach($recommend_goods_list['goods_new_list'] as $k=>$list): ?>
					<li class="gooditem">
						<div class="imgs">
							<a href="<?php echo __URL('APP_MAIN/goods/goodsdetail?id='.$list['goods_id']); ?>">
								<img src="<?php echo __IMG($default_goods_img); ?>" class="lazy_load" data-original="<?php echo __IMG($list['pic_cover_mid']); ?>" >
							</a>
						</div>
						<div class="info">
							<p class="goods-title">
...
<?php endif; ?>
<!-- 精品 -->
<?php if(count($recommend_goods_list['goods_recommend_list'])): ?>
	<div class="floor">
		<div class="category_name">
			<span class="floor-left-nav"><i class="title-border"></i>精品</span>
			<!-- <a class="floor-right-nav" href="<?php echo __URL('APP_MAIN/goods/goodslist?category_id='.$class['category_id']); ?>">查看更多</a> -->
		</div>
		<section class="members_goodspic">
			<ul>
				<?php if(is_array($recommend_goods_list['goods_recommend_list']) || $recommend_goods_list['goods_recommend_list'] instanceof \think\Collection || $recommend_goods_list['goods_recommend_list'] instanceof \think\Paginator): if( count($recommend_goods_list['goods_recommend_list'])==0 ) : echo "" ;else: foreach($recommend_goods_list['goods_recommend_list'] as $k=>$list): ?>
					<li class="gooditem">
						<div class="imgs">
							<a href="<?php echo __URL('APP_MAIN/goods/goodsdetail?id='.$list['goods_id']); ?>">
								<img src="<?php echo __IMG($default_goods_img); ?>" class="lazy_load" data-original="<?php echo __IMG($list['pic_cover_mid']); ?>" >
...
<?php endif; ?>
<!-- 热卖 -->
<?php if(count($recommend_goods_list['goods_hot_list'])): ?>
	<div class="floor">
		<div class="category_name">
			<span class="floor-left-nav"><i class="title-border"></i>热卖</span>
			<!-- <a class="floor-right-nav" href="<?php echo __URL('APP_MAIN/goods/goodslist?category_id='.$class['category_id']); ?>">查看更多</a> -->
		</div>
		<section class="members_goodspic">
			<ul>
				<?php if(is_array($recommend_goods_list['goods_hot_list']) || $recommend_goods_list['goods_hot_list'] instanceof \think\Collection || $recommend_goods_list['goods_hot_list'] instanceof \think\Paginator): if( count($recommend_goods_list['goods_hot_list'])==0 ) : echo "" ;else: foreach($recommend_goods_list['goods_hot_list'] as $k=>$list): ?>
					<li class="gooditem">
						<div class="imgs">
							<a href="<?php echo __URL('APP_MAIN/goods/goodsdetail?id='.$list['goods_id']); ?>">
								<img src="<?php echo __IMG($default_goods_img); ?>" class="lazy_load" data-original="<?php echo __IMG($list['pic_cover_mid']); ?>" >
...
<div class="footer">
	<div class="copyright" id="bottom_copyright" style="display: none">
	...
	<div class="copyright" style="    text-align: center;"><?php if(empty($_W['setting']['copyright']['footerleft'])): ?>Powered by <a href="http://www.we7.cc"><b>微擎</b></a> v2.0.7 © 2014-2015 <a href="http://www.we7.cc">www.we7.cc</a><?php else: ?><?php echo $_W['setting']['copyright']['footerleft']; endif; ?></div>
