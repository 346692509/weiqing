	...
	public function searchWithExprie() {
		$this->query
			...
			->where(function ($query) {
				$query->where(array('c.role' => 'owner', 'u.endtime >' => USER_ENDTIME_GROUP_UNLIMIT_TYPE, 'u.endtime <' => TIMESTAMP))
					->whereor(array('b.endtime <' => TIMESTAMP, 'b.endtime >' => USER_ENDTIME_GROUP_UNLIMIT_TYPE));
			});
		return $this;
	}
