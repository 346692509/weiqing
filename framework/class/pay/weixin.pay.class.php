...
class WeiXinPay extends pay{
	...
	public function parseResult($result) {
		...
		if((isset($result['return_code']) && $result['return_code'] != 'SUCCESS') || (isset($result['result_code']) && $result['result_code'] != 'SUCCESS') || ($result['err_code'] == 'ERROR' && !empty($result['err_code_des']))) {
